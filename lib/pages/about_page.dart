                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              PoppinsTextWidget(
                                  text:
                                      'An employer is a person who is looking to employ or hire others to work for them or their company.\nRegistering as an Employer allows you to create job posts. These posts are available for all Jobseekers to check and apply for.\n\nEmployers can also:',
                                  size: fontLabel,
                                  // isBold: true,
                                  color: dark),
                              y4,
